...
class BertSeqTransform:
    ...
    def __call__(self, segment):
        ...
        for token in segment:
            ...
            #tags += [self.vocab.tags[0].get_stoi()[token.gold_tag[0]]]  * (len(token_subwords))
            #print(tags)
            #tags += [self.vocab.tags[0].get_stoi()[token.gold_tag[0]]] + [-100] * (len(token_subwords) - 1)
        ...
        #print(f'tokens: {len(tokens)} tags: {len(tags)} subwords: {len(subwords)}')
