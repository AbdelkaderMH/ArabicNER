...
class BertTrainer(BaseTrainer):
    def __init__(self, **kwargs):
        ...
        self.criterion = loss_functions.UnifiedLoss(weight_dice=1, weight_tversky=1, weight_focal=1)
    ...
    def train(self):
        ...
        for epoch_index in range(self.max_epochs):
            ...
            for batch_index, (_, gold_tags, tokens, _, logits) in enumerate(self.tag(
                ...
                batch_loss = self.criterion(logits.view(-1, logits.shape[-1]), gold_tags.view(-1))
                batch_loss.backward()
    ...
    def tag(self, dataloader, is_train=True):
        ...
        for subwords, gold_tags, tokens, valid_len in dataloader:
            ...
            if is_train:
                ...
                logits = self.model(subwords, gold_tags)
            else:
                with torch.no_grad():
