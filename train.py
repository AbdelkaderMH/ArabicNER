...
def main(args):
    ...
    if "Nested" in args.data_config["fn"]:
    ...
    args.optimizer["kwargs"]["params"] = optimizer_grouped_parameters#model.parameters()
    optimizer = load_object(args.optimizer["fn"], args.optimizer["kwargs"])

    args.lr_scheduler["kwargs"]["optimizer"] = optimizer
    epochs = args.trainer_config['kwargs']['max_epochs']
    ...
    warmup_steps = int(epochs * train_data_size * 0.1 / args.batch_size)
